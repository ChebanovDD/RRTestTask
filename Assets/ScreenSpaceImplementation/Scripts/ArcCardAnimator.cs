...
{
    public class ArcCardAnimator : CardAnimator
    {
        ...
        public override Sequence SetCardTransform(ICard card, CardTransform cardTransform)
        {
            return DOTween.Sequence()
                ...
                .SetEase(_easeType).OnComplete(() => { card.SetTransform(cardTransform); });
        }

        public override Sequence ActivateCard(ICard card)
        {
            return DOTween.Sequence()
        ...
        public override Sequence DeactivateCard(ICard card)
        {
            return DOTween.Sequence()
